...
class CreditController(
    private val creditServiceImpl: CreditServiceImpl
) {
    @PostMapping("/criar")
    fun saveCredit(@RequestBody @Valid creditDto: CreditDTO): ResponseEntity<String> {
        val credit: Credit = this.creditServiceImpl.save(creditDto.toEntity())
    ...
    fun findAllByCustomerId(@RequestParam(value = "customerId") customerId: Long):
        ...
        val creditViewList: List<CreditViewList> = this.creditServiceImpl.findAllByCustomer(customerId)
            .stream()
    ...
    fun findByCreditCode(
        ...
        val credit: Credit = this.creditServiceImpl.findByCreditCode(customerId, creditCode)
